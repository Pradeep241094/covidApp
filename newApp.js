...
function PractionerStackScreen() {
  return (
    <FeedStack.Navigator>
      <FeedStack.Screen options={{ headerShown: false }} name='Splash' component={Splashscreen} />
      <FeedStack.Screen options={{ headerShown: false }} name='Auth' component={AuthScreen} />
      <FeedStack.Screen name="Practioner" component={PractionerView} />
    </FeedStack.Navigator>
  )
}
...
function PractionerTabs() {
  return (
    <Tab.Navigator>
      <Tab.Screen name="Practioner" component={PractionerStackScreen} />
    </Tab.Navigator>
  );
}
          ...
          tokenPresent ?
            <NavigationContainer>
              {this.state.isSignedUp ?
                <RootStack.Navigator>
                  <RootStack.Screen name="Practioner" component={PractionerTabs} />
                </RootStack.Navigator>
                :
                <RootStack.Navigator>
                  <RootStack.Screen name="Practioner" component={PractionerTabs} />
